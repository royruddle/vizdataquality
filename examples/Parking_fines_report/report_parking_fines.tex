...
\usepackage{geometry} % Required to set page size, margins, etc
\usepackage{hyperref} % Required for hyperlinks and urls
...
This report has been produced by applying the vizdataquality package to investigate data quality of a dataset about fines that were issued for all of the car parks in a city, during a three month period. The data is (c) Leeds City Council, 2019, \url{https://datamillnorth.org/dataset/v8ggw/off-street-parking-fines}, and is licensed under the terms of the Open Government Licence (\url{https://www.nationalarchives.gov.uk/doc/open-government-licence/version/2/}).
...
\section{Step 1: Is anything obviously wrong (look at your data and any documentation)?}
...
\begin{figure}[ht]
  \centering
  \includegraphics{value_counts_PCN.jpg}
...
\begin{figure}[ht]
  \centering
  \includegraphics{value_counts_LOCATION.jpg}
...
\begin{figure}[ht]
  \centering
  \includegraphics{value_counts_CONTRAVENTION.jpg}
