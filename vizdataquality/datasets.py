...
def get_dataset(option):
    ...
    if option == 'simple':
        ...
        data = {}
        data['Categorical'] = ['c']  + ['b'] * 3 + ['a'] * 6
        data['Categorical (ints)'] = [1] * 2 + [i for i in range(3, 10)] + [12]
        data['Integer'] = [12]  + [11] * 3 + [-1] * 6
        data['Float'] = [0.9]  + [0.2] * 3 + [0.1] * 6
        data['Date'] = ['2000-01-01']  + ['2020-01-01'] * 3 + ['2021-01-01'] * 6
